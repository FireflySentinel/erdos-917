...
The formalization covers Lemmas~\ref{lem:module} and~\ref{lem:saturation},
Proposition~\ref{prop:conversion}, and Theorem~\ref{thm:main}, including the
definition of \(f_{12}\) and the statement that \(f_{12}(n)/n^2\) has no limit
below \(2/5\); the Remark on other chromatic numbers is not formalized.
