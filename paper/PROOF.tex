...
The case \(t=2\) reduces to the classical two-module construction
\cite[Section~2.1]{Pegden} and gives no improvement.
For upper bounds on \(f_k(n)\), see Luo, Ma, and Yang
\cite[Theorem~1.1]{LMY}.
Section~\ref{sec:main-proof} completes the proof of
...
maximum degree \(d_v=O_t(\sqrt v)\). For the triangle-free case,
see also \cite{HansonSeyffarth,FurediSeress}.
...
A Lean 4 formalization of Theorem~\ref{thm:main} and
Corollary~\ref{cor:general}, including a formal verification of
the saturated-graph construction, is available at
