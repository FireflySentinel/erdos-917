...
We use the construction in \cite[Section~4, Example~2]{AEHK} and
include its saturation verification below.
...
\[
 h=3^s,\qquad Q=h^2,
\]
and take \(H=H_{5,Q}\) from Lemma~\ref{lem:saturation}. Write
